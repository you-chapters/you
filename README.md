...
- **Narrative recap** *(next step)* — ISO-week and monthly free-form prose generated by LLM (gpt-4o-mini), cached in `you_narratives` DynamoDB table; current period refreshes daily, past periods frozen; Stage 1: lazy on-demand, Stage 2: EventBridge cron ensures every period is covered
...
- EventBridge — scheduled cron triggers (narrative generation)
